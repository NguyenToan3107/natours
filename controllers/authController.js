...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  // truoc khi gan cho currentUser thif req.user = undifined
  req.user = currentUser;
  res.locals.user = currentUser;
  next();
});

// Onlyfor rendered pages, no errors!
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2. If token has not expired, and there is user, set the n ew password
